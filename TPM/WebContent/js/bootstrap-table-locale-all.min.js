...
!function(a) {
	...
	a.fn.bootstrapTable.locales["ca-ES"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Mostrant de " + a + " fins " + b + " - total " + c
					+ " resultats"
		},
		formatSearch : function() {
			return "Buscar"
	...
	a.fn.bootstrapTable.locales["de-DE"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Zeige " + a + " bis " + b + " von " + c + " Zeile"
					+ (c > 1 ? "n" : "")
		},
		formatSearch : function() {
			return "Suchen"
	...
	a.fn.bootstrapTable.locales["el-GR"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Εμφανίζονται από την " + a + " ως την " + b
					+ " από σύνολο " + c + " σειρών"
		},
		formatSearch : function() {
			return "Αναζητήστε"
	...
	a.fn.bootstrapTable.locales["es-CR"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Mostrando de " + a + " a " + b + " registros de " + c
					+ " registros en total"
		},
		formatSearch : function() {
			return "Buscar"
	...
	a.fn.bootstrapTable.locales["es-ES"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Mostrando desde " + a + " hasta " + b + " - En total " + c
					+ " resultados"
		},
		formatSearch : function() {
			return "Buscar"
	...
	a.fn.bootstrapTable.locales["et-EE"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Näitan tulemusi " + a + " kuni " + b + " - kokku " + c
					+ " tulemust"
		},
		formatSearch : function() {
			return "Otsi"
	...
	a.fn.bootstrapTable.locales["fr-FR"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Affichage des lignes " + a + " à " + b + " sur " + c
					+ " lignes au total"
		},
		formatSearch : function() {
			return "Rechercher"
	...
	a.fn.bootstrapTable.locales["hr-HR"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Prikazujem " + a + ". - " + b
					+ ". od ukupnog broja zapisa " + c
		},
		formatSearch : function() {
			return "Pretraži"
		},
	...
	a.fn.bootstrapTable.locales["ka-GE"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "ნაჩვენებია " + a + "-დან " + b + "-მდე ჩანაწერი ჯამური "
					+ c + "-დან"
		},
		formatSearch : function() {
			return "ძებნა"
	...
	a.fn.bootstrapTable.locales["ms-MY"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Sedang memaparkan rekod " + a + " hingga " + b
					+ " daripada jumlah " + c + " rekod"
		},
		formatSearch : function() {
			return "Cari"
		},
	...
	a.fn.bootstrapTable.locales["ro-RO"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Arata de la " + a + " pana la " + b + " din " + c
					+ " randuri"
		},
		formatSearch : function() {
			return "Cauta"
	...
	a.fn.bootstrapTable.locales["th-TH"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "รายการที่ " + a + " ถึง " + b + " จากทั้งหมด " + c
					+ " รายการ"
		},
		formatSearch : function() {
			return "ค้นหา"
	...
	a.fn.bootstrapTable.locales["vi-VN"] = {
		...
		formatShowingRows : function(a, b, c) {
			return "Hiển thị từ trang " + a + " đến " + b + " của " + c
					+ " bảng ghi"
		},
		formatSearch : function() {
			return "Tìm kiếm"
